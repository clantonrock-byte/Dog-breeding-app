 ...
 *
 * Bundle wrapper for Dogs.
 * - Loads the unified Dogs renderer (v5) and ensures it wins after the compiled app renders legacy lists.
 *
 * NOTE: This file intentionally *contains* the v5 logic so you can delete older dog patch files later.
 */
(() => {
  "use strict";
  ...
  function hookAfterShow() {
    ...
    if (prev && prev._ccDogBundleWrapped) return;
    ...
    window.__afterShow._ccDogBundleWrapped = true;
  }
