/**
 * portal/dog_profile_rebuild_v3_7.js
 *
 * v3.7 = same logic as v3.6, but NO <details>/<summary> accordions.
 * Everything is rendered as normal sections for easier mobile UX.
 *
 * Install:
 *  - Upload JS+CSS to /portal
 *  - In root index.html:
 *      <link rel="stylesheet" href="portal/dog_profile_rebuild_v3_7.css" />
 *      <script src="portal/dog_profile_rebuild_v3_7.js"></script>   (last)
 *  - Remove old rebuild scripts (v3.6 and earlier) from footer.
 */
(() => {
  "use strict";
  ...
  function render(profile){
    ...
    if(!ctx){
      ...
      wrap.innerHTML = `
        <div class="bp-title">Profile</div>
        <div class="muted small">V3.7 loaded, but dogId is not resolved yet.</div>
  ...
  function hook(){
    ...
    if(prev && prev._bpProfileRebuildV37Wrapped) return;
    ...
    window.__afterShow._bpProfileRebuildV37Wrapped=true;
  }
